...
//	I now prefer the main ganme to directly modify the GlobRef on need,
//	which is clearer, overall.
//------------------------------------------------------------------------------
...
ULong	
		...
		GR_Scram_Skill[8]={0},
		GR_Scram_Squad[8]={0};
//DEADCODE RJS 15/02/00 		GR_Pack_TakeTime[8][3]={0};
...
static	ULongRef
			GR_Pack_Target0=GR_Pack_Target[0],
			GR_Pack_Target1=GR_Pack_Target[1],
			GR_Pack_Target2=GR_Pack_Target[2],
			GR_Pack_Target3=GR_Pack_Target[3],
			GR_Pack_Target4=GR_Pack_Target[4],
			GR_Pack_Target5=GR_Pack_Target[5],
			GR_Pack_Target6=GR_Pack_Target[6],
			GR_Pack_Target7=GR_Pack_Target[7],
			GR_Pack_Target8=GR_Pack_Target[8],
			GR_Pack_Target9=GR_Pack_Target[9],
...
void	Persons2::WipeGlobrefPackVars()	//In tank when we are about to load a package
{
...
void	Persons2::ClearGlobrefPackVars()	//Before FindNextBf
{
	for (int i=SGR_WPP_TakeOff;i<=SGR_WPP_Msg9;i++)
...
void	Persons2::ResetGlobrefPackVars()	//After FindNextBf
{
	for (int i=SGR_WPP_TakeOff;i<=SGR_WPP_Msg9;i++)
