...
void*		loadCDfile(FileNum,SLong,SLong,Bool skipread=TRUE);	//PD 18Nov96
void		pingCD();											//PD 17Dec96
void	MakeRoomFor(int delta)	{fileman::MakeRoomFor(delta);}

Bool	LoadedNumberedFile(FileNum filenum,int offset=0)	{return loadednumberedfile(filenum,offset);}
...
void	DebugLog(char*,...);									//RJS 25Sep00
