...
/*ScaleType*/	scaletype 	: 2,	//Size or Group flag
				hasWire		: 1;	//Does it have a wire to collide with?//RJS 03Feb00
}
...
typedef	struct	Shape_Desc										//RJS 02Dec97
{
	...
	UWord		damagedshpref,	 //need Fast routine to generate dopoint 0 on body0
				dyingshpref;
	UWord		repairshpref;									//RJS 09Nov99
	...
	UWord		InteractiveOffset;								//RJS 19Nov99
}
ShapeDesc,
...
//Old_Code PD 27Aug96 		void	AddShapesToGlobList(UWord *,UWord&);
	...
	protected:
		...
		void	FixupNAnimVec(UByte *&,ULong &);				//RJS 17Feb00
		...
		void	FixupDoNTriangles(UByte *&,ULong &);			//RJS 10Nov99
		void	FixupDoNMaxPoints(UByte *&,ULong &);			//RJS 10Nov99
		void	FixupDoAnimTransform(UByte *&,ULong &);			//RJS 10Nov99
		void	FixupDoTMorphNPoints(UByte *&,ULong &);			//RJS 01Dec99
		void	FixupDoAbsTimerPhase(UByte *&,ULong &);			//RJS 02Dec99
		void	FixupDoAnimTransformHP(UByte *&,ULong &);		//RJS 03Dec99
		void	FixupBitsOffCockUnSet(UByte *&,ULong &);		//RJS 3/22/00
		void	FixupCollisionGoto(UByte *&,ULong &);			//RJS 21Sep00
		void	FixupDoNormal(UByte *&,ULong &);						//RJS 28Sep00
