...
const	UWord	PADLOCKTIMEOUT = 1000;									//RJS 10Oct00
const	UWord	DEADTIMEOUT_NORM = 1500;								//RJS 10Oct00
const	UWord	DEADTIMEOUT_DELAYED = 3000;								//RJS 10Oct00
const	UWord	DEADTIMEOUT_RECYCLE = 0x8000;							//RJS 10Oct00
...
{																//RJS 02Sep98
	...
	DEATH_AIRTOGROUND,											//RJS 23Mar00
	DEATH_TUMBLE												//RJS 23Mar00
};																//RJS 03Sep98
...
/**/#endif
					...
					VM_Map,
					VM_Prefs, //PD 03/12/99
					VM_RovingCamera}; //PD 03/12/99
...
enum	ZmRtFlags	{ZR_NULL=0,
					...
					ZR_HeadLeft = 0x30,	ZR_HeadRight = 0x40,	//RJS 27Mar00
					ZR_FrontGun = 0x50, ZR_TopGun = 0x60,		//RJS 02May00
					ZR_BotGun = 0x70,							//RJS 02May00
					ZR_HeadDown = 0x80,									//RJS 4Oct00
					ZR_BIG=0x90};								//RJS 02May00
...
{ 
	...
	*Viewpoint_DeltaP;
	...
	{
		COORDS3D	World;
		Angles		rovingH,rovingP;
		SLong		rovingT;
	};

	RovingStruc rovingData;

private:
	static	View_Key	VieweeList[] ;
	static	View_Key	ViewTypeList[] ;
	static	View_Key	ViewSpecList[] ;
//	static	Zoom_Key	ViewRotList[] ;

public:

	Float	perspective_FoV;									//RJS 21Mar00
	Float	perspective_Width;									//RJS 21Mar00

	itemptr	currentvehicle,
			trackeditem,										//PD 29Feb96
			trackeditem2,
			previousvehicle;
	ULong getFrameTimeMSecs( void ) { return frameTimeMSecs; }

private:

	int		draw_frametimeMS;											//RJS 27Sep00
	int		draw_frametime;										//RJS 05Apr00
	int		realdraw_frametime;									//RJS 05Apr00
	int		totaldraw_frametime;								//RJS 05Apr00
	ULong	frameTimeMSecs;												//JON 5/11/00

	SWord	eyeDeltaX;													//RJS 12Oct00
	...
	View_RecP	globalviewrec,									//PD 27Feb96
				...
				deathviewtumblerec,								//RJS 23Mar00
				maprec,											//PD 19Nov98
	...
	Zoom_KeyP	viewrot_list,									//PD 14Aug97
				...
				viewhead_list,									//RJS 02May00
				viewrotgunner_list;								//RJS 02May00
...
//DEADCODE PD 01/12/99 	Bool		bDoingHW3D;
	Bool		bPadlockOut;
	...
	ULong		avFrameTimeMS;											//RJS 20Sep00
	SLong		avFrameCnt;												//RJS 21Sep00
	ULong		avFrameTimeTotMS;										//RJS 21Sep00

	public:

		void UnQuit3D() ;												// AMM9Oct00
		void Quit3D(ULong);												//RJS 27Sep00
		bool Accel();
...
//DEAD		ANGLES	viewitemhdg;									//PD 05Jul96
		...
		SWord		eyeHeading;									//RJS 10Mar00
		SWord		eyePitch;											//RJS 12Oct00


		ULong	move_time_ms;											//CSB 02/03/00
//////////////////////////////
		CON		ViewPoint(CLib3D*,View3d* v);
 		DES		~ViewPoint();

		void ReturnFromMap();									//PD 16Feb99

		inline int	DrawFrameTimeMS(){return draw_frametimeMS;}			//RJS 27Sep00
		inline int	DrawFrameTime(){return draw_frametime;}				//RJS 05Apr00
		inline int	RealDrawFrameTime(){return realdraw_frametime;}		//RJS 05Apr00
		inline int	TotalDrawFrameTime(){return totaldraw_frametime;}	//RJS 05Apr00
		void	SetDrawFrameTime(ULong&);						//RJS 05Apr00
...
//DeadCode JON 23Oct00 		SLong BuildPeripheralVisionList(PVList*,SLong);		//PD 22Jul97
		...
		void GetControlView(SWord&,SWord&);						//RJS 28Feb00
		bool InCockpit();

		void	FocusCockpit();											//RJS 7Sep00
		void	AddHeadOffset(const SLong, const SLong);				//RJS 10Oct00
		void	GetControlViewNewEye(const SWord&, const SWord&, SWord&, SWord&);	//RJS 12Oct00
		void	ForceToOutside();										//RJS 24Oct00
...
//dead		void CommsStuff();										//PD 18Sep97
		...
		bool	DoWeAbortTrack();										//RJS 28Jul00
		inline	bool	GuyIsAlive(const	ItemPtr);					//RJS 11Aug00
		inline	void	CalcSmoothAngle(const ANGLES,ANGLES&);			//RJS 19Sep00

		void	InitPadlockedItem();									//RJS 29Sep00
	...
	protected:
		...
		void GetHPIntercept(itemptr ip1,itemptr, ANGLES&, ANGLES& ,int&);		//PD 27Feb96
		void AddViewRec();
		void AddViewRecInside();								//PD 14Jun96
		void ClipInsideAngles();								//PD 17Jun96
		void AddZoom();												//RJS 2Oct00
		...
		Float	RangeCheck(ItemPtr entry,Float minval,Float maxval);
		bool	VisibleConeCheck(ItemPtr	entry);
...
//DEAD		itemptr GetPrevMessage();								//PD 08Oct97
		...
		itemptr GetNextItem	(	MobileItemPtr	list,		//List ptr
								MobileItemPtr	saglist,
								MobileItemPtr	curr,		//Current ptr
								Nationality		side,		//Side
								SLong&			currrange	//Current range
							);

		itemptr GetPrevItem	(	MobileItemPtr	list,		//List ptr
								MobileItemPtr	saglist,
								MobileItemPtr	curr,		//Current ptr
								Nationality		side,		//Side
								SLong&			currrange	//Current range
...
//DEAD				PInitMessage,									//PD 08Oct97
		...
		ZmRtRtn	HandleZoom,
				...
				ResetZoomRotate,
				ResetZoomRotat2,
				HandleHead,										//RJS 02May00
				HandleGunner,									//RJS 01Sep00
				HandleGunnerRotate,										//RJS 26Oct00
				HandleNull;										//RJS 01Sep00
