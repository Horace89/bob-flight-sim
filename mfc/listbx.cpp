...
// NOT A RowanDialog: // ListBx.cpp : implementation file
//
...
//DEADCODE DAW 02/02/00 	ON_MESSAGE( WM_GETARTWORK, OnGetArtWork)
END_MESSAGE_MAP()
...
afx_msg	int	CListBx::OnGetArtWork()
{	//not used!
	int rv=GetParent()->SendMessage(WM_GETARTWORK,NULL,NULL);
	return rv+(rv<<16);
