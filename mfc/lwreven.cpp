...
// RowanDialog: // LWRevEn.cpp : implementation file
//
...
RDialog*	LWReviewEnemy::Make()
{
	return
		MakeTopDialog(::Place(POSN_CENTRE,POSN_CENTRE),
			DialBox(FIL_NULL,new LWReviewEnemy())
			);
}


LWReviewEnemy::LWReviewEnemy(CWnd* pParent /*=NULL*/)
	: RowanDialog(LWReviewEnemy::IDD, pParent)
{
	//{{AFX_DATA_INIT(LWReviewEnemy)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void LWReviewEnemy::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(LWReviewEnemy)
	DDX_Control(pDX, IDC_RLISTBOXCTRL1, m_IDC_RLISTBOXCTRL1);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(LWReviewEnemy, CDialog)
	//{{AFX_MSG_MAP(LWReviewEnemy)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// LWReviewEnemy message handlers

BOOL LWReviewEnemy::OnInitDialog() 
{
