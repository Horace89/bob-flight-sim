...
// RowanDialog: // LWRouteT.cpp : implementation file
//
...
LWRouteTop::LWRouteTop(CWnd* pParent /*=NULL*/)
	: RowanDialog(LWRouteTop::IDD, pParent)
{
	//{{AFX_DATA_INIT(LWRouteTop)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void LWRouteTop::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(LWRouteTop)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(LWRouteTop, CDialog)
	//{{AFX_MSG_MAP(LWRouteTop)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// LWRouteTop message handlers
