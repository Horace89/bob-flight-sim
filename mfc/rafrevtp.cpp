...
// RowanDialog: // RAFRevTp.cpp : implementation file
//
...
RAFReviewTop::RAFReviewTop(CWnd* pParent /*=NULL*/)
	: RowanDialog(RAFReviewTop::IDD, pParent)
{
	//{{AFX_DATA_INIT(RAFReviewTop)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void RAFReviewTop::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(RAFReviewTop)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(RAFReviewTop, CDialog)
	//{{AFX_MSG_MAP(RAFReviewTop)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// RAFReviewTop message handlers
