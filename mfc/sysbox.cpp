...
/////////////////////////////////////////////////////////////////////////////
// CSystemBox dialog
void	CSystemBox::OnOK()	
{
	INT3;
//DeadCode MS 16Nov00 	CDialog::OnOK();
}
void	CSystemBox::OnCancel()				
{
	INT3;
//DeadCode MS 16Nov00 	CDialog::OnCancel();
}
...
CSystemBox::~CSystemBox()
{
	CMainFrame* main=(CMainFrame*)AfxGetMainWnd();
	if (main)
		main->m_wndSystemBox=NULL;
}
...
//DEADCODE RDH 09/11/99 	m_pParent->OnGoSmall();
	if (!LoggedChild(0))
		LogChild(0,ToolBarControl::Make()
						);
	else
		CloseLoggedChild(0);
...
void CSystemBox::OnClickedZoomin() 
{
	...
	// TODO: Add your control notification handler code here
//DeadCode JIM 20Oct00 	CRButton* z=GETDLGITEM(IDC_ZOOMIN);
...
void CSystemBox::OnContextMenu(CWnd* pWnd, CPoint point) 
{
	// TODO: Add your message handler code here
	CMainFrame* main=(CMainFrame*)AfxGetMainWnd();
	main->MakeToolMenu(point,9)	;
	
}

void CSystemBox::OnMove(int x, int y) 
{
	CDialog::OnMove(x, y);
...
void CSystemBox::OnSize(UINT nType, int cx, int cy) 
{
