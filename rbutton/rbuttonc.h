...
//	BOOL m_bPressed;
	...
	BOOL m_bShowShadow;
	enum	ButtonPos	{Pressed,ClosePressed,TickPressed,HelpPressed,NotPressed};
	ButtonPos	m_buttonpos;
	BOOL	m_b[NotPressed];
	HICON m_closeUpIcon;
	HICON m_closeDownIcon;
	BOOL m_bCloseButton;
//DeadCode JIM 9Aug00 	BOOL m_bClosePressed;

	HICON m_tickUpIcon;
	HICON m_tickDownIcon;
	BOOL m_bTickButton;
//DeadCode JIM 9Aug00 	BOOL m_bTickPressed;

	HICON m_helpUpIcon;
	HICON m_helpDownIcon;
	BOOL m_bHelpButton;
//DeadCode JIM 9Aug00 	BOOL m_bHelpPressed;
	...
	~CRButtonCtrl();
	ButtonPos	GetPressMouseOver(CPoint point);
	void	DisplayHint();
...
public:
	...
	int DrawBitmapWithTransparencies(FileNum filenum,CDC* pdc);
