...
public:
	...
	void DrawTransparentBitmap(IconsUI iconnum,CDC * pDC, int x, int y);
...
// Dispatch maps
	...
	afx_msg long GetNewJimVar();
	afx_msg void SetNewJimVar(long nNewValue);
...
public:
	...
	dispidNewJimVar = 8L,
	dispidAddString = 9L,
	dispidGetListbox = 10L,
	dispidSetIndex = 11L,
	dispidGetIndex = 12L,
	dispidClear = 13L,
	dispidDeleteString = 14L,
