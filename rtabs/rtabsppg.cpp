...
IMPLEMENT_OLECREATE_EX(CRTabsPropPage, "RTABS.RTabsPropPage.1",
	0x4a1e1987, 0x8b31, 0x11d6, 0xa1, 0xf0, 0x44, 0x45, 0x53, 0x54, 0, 0)
...
void CRTabsPropPage::DoDataExchange(CDataExchange* pDX)
{
	...
	{
		Font_Combo_Texts.SetComboList(&m_FontCombo);
	}

	//{{AFX_DATA_MAP(CRTabsPropPage)
	DDP_CBIndex(pDX, IDC_COMBO1, m_FontNum, _T("FontNum") );
	DDX_CBIndex(pDX, IDC_COMBO1, m_FontNum);
	DDP_Check(pDX, IDC_CHECK1, m_SetShadow, _T("SetShadow") );
	DDX_Check(pDX, IDC_CHECK1, m_SetShadow);
	//}}AFX_DATA_MAP
